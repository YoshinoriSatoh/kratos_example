...
func (p *Provider) handleGetMyPassword(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		tmpl.ExecuteTemplate(w, templatePaths.MyPasswordIndex, viewParameters(session, r, map[string]any{
...
func (p *Provider) handlePostMyPassword(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		tmpl.ExecuteTemplate(w, templatePaths.MyPassword_Form, viewParameters(session, r, map[string]any{
			"SettingsFlowID":       reqParams.flowID,
			"CsrfToken":            reqParams.csrfToken,
			"Password":             reqParams.password,
			"ValidationFieldError": validationFieldErrors,
...
func (p *Provider) handleGetMyProfile(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		tmpl.ExecuteTemplate(w, templatePaths.MyProfileIndex, viewParameters(session, r, map[string]any{
			"ErrorMessages": output.ErrorMessages,
		}))
	}
...
func (p *Provider) handleGetMyProfileEdit(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		tmpl.ExecuteTemplate(w, templatePaths.MyProfileEdit, viewParameters(session, r, map[string]any{
			"ErrorMessages": output.ErrorMessages,
		}))
	}
...
func (p *Provider) handleGetMyProfileForm(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		tmpl.ExecuteTemplate(w, templatePaths.MyProfile_Form, viewParameters(session, r, map[string]any{
			"ErrorMessages": output.ErrorMessages,
		}))
	}
