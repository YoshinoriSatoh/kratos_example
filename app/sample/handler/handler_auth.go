...
func (p *Provider) handleGetAuthVerification(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		w.WriteHeader(http.StatusOK)
		tmpl.ExecuteTemplate(w, "auth/verification/index.html", viewParameters(session, r, map[string]any{
			"ErrorMessages": output.ErrorMessages,
		}))
		return
	}
...
func (p *Provider) handleGetAuthVerificationCode(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		w.WriteHeader(http.StatusOK)
		tmpl.ExecuteTemplate(w, "auth/verification/code.html", viewParameters(session, r, map[string]any{
			"ErrorMessages": output.ErrorMessages,
		}))
		return
	}
...
func (p *Provider) handlePostVerificationEmail(w http.ResponseWriter, r *http.Request) {
	...
	validationFieldErrors := reqParams.validate()
	if len(validationFieldErrors) > 0 {
		tmpl.ExecuteTemplate(w, "auth/verification/_code_form.html", viewParameters(session, r, map[string]any{
...
func (p *Provider) handleGetAuthLogin(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		tmpl.ExecuteTemplate(w, "auth/login/index.html", viewParameters(session, r, map[string]any{
			"ErrorMessages": output.ErrorMessages,
		}))
		return
	}
...
func (p *Provider) handleGetAuthRecovery(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		w.WriteHeader(http.StatusOK)
		tmpl.ExecuteTemplate(w, "auth/recovery/index.html", viewParameters(session, r, map[string]any{
			"ErrorMessages": output.ErrorMessages,
		}))
		return
	}
...
func (p *Provider) handlePostAuthRecoveryEmail(w http.ResponseWriter, r *http.Request) {
	...
	validationFieldErrors := reqParams.validate()
	if len(validationFieldErrors) > 0 {
		tmpl.ExecuteTemplate(w, "auth/recovery/_code_form.html", viewParameters(session, r, map[string]any{
